...
If you are using Solid and load plugin modules from disk at runtime, also see the runtime support import on the [Solid slots page](/docs/plugins/solid#runtime-loaded-external-plugins).
